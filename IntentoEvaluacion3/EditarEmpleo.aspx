<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditarEmpleo.aspx.cs" Inherits="IntentoEvaluacion3.EditarEmpleo" %>
    ...
    <div style="display: none;">
     ...
     <div class="form-container">
        <div class="form-wrapper">
            ...
            <br/>
            <asp:Button ID="btn_publicarEmpleo" runat="server" Text="Editar" CssClass="btnPublicarEmpleo" OnClick="btn_publicarEmpleo_Click"/>
            <asp:Label ID="lbl_msjErrorForm" CssClass="lbl-msjError" runat="server" Text=""></asp:Label>
        </div>
    </div>
